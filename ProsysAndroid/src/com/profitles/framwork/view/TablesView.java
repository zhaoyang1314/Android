...
public class TablesView extends BaseAdapter {    
    private Context context;    
    private List<TableRow> table;    
    public TablesView(Context context, List<TableRow> table) {    
        ...
        public TableRowView(Context context, TableRow tableRow) {    
            ...
            for (int i = 0; i < tableRow.getSize(); i++) {//逐个格单元添加到行    
                ...
                if (tableCell.type == TableCell.STRING) {//如果格单元是文本内容    
                    ...
                    textCell.setBackgroundColor(Color.GREEN);
    ...
    class TableRowViews extends LinearLayout {    
        public TableRowViews(Context context, TableRow tableRow) {    
            super(context);    
