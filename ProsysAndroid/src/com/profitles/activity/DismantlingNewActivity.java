...
public class DismantlingNewActivity extends AppFunActivity {
...
//					showConfirm("当前单件标签已存在托盘信息中,是否删除?", scfListenPorScan);
					etxsendSn.reValue();
					return false;
				}
			}else{
...
//		}
	...
	private OnShowConfirmListen scfListenPorScan=new OnShowConfirmListen() {

		@Override
		public void onConfirmClick() { // 确认事件
			loadDataBase(new IRunDataBaseListens() {
		...
		@Override
		public void onCancelClick() { // 取消按钮
