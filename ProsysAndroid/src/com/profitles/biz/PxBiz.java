...
public class PxBiz extends BaseBiz {
	
	//单号
	public WebResponse pxCheckBar(String domain,String site,String code) {
	...
	//提交数据上海日精
		public WebResponse newPxSub(String domain, String site,String userId,String json,String toLot,String marginQty,String sumQty,String fnceffdate,String bin,String um,String cust_part,String po_nbr) {
			WebResponse wrp = getWcuCP().addParam("domain", domain).addParam("site", site).addParam("userId", userId).addParam("json",json)
					.addParam("toLot", toLot).addParam("marginQty", marginQty).addParam("sumQty", sumQty).addParam("fnceffdate", fnceffdate)
					.addParam("bin", bin).addParam("um", um).addParam("cust_part", cust_part).addParam("po_nbr", po_nbr).execRtn("newPxSub");
			return wrp;
		}	
